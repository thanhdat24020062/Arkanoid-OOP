...
public class Assets {
    ...
    public static void load() {
        ...
        // background = Files.loadImage("src/main/resources/images/background.png");
        paddle = Files.loadImage("/images/paddle.png");
        ball = Files.loadImage("/images/ball.png");

        bricks.add(Files.loadImage("/images/brick_gold.png"));
        bricks.add(Files.loadImage("/images/brick_orange.png"));
        bricks.add(Files.loadImage("/images/brick_silver_2.png"));
        bricks.add(Files.loadImage("/images/brick_blue.png"));
        bricks.add(Files.loadImage("/images/brick_cyan.png"));
